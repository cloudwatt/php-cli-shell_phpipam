<?php
	...
	class Api_Universal
	{
		...
		public function getNmi($hostName, $gateway = true)
		{
			...
			$mgmtDatas = $IPAM->getByEquipLabelVlanRegex($hostName, $vlanName, 4);
		...
		{
			$callable = array(self::$_IPAM, $name);
			return call_user_func_array($callable, $arguments);
		}

		public static function __callStatic($name, $arguments)
		{
			$callable = array(get_class(self::$_IPAM), $name);
			return forward_static_call_array($callable, $arguments);
		}

		public static function setIpam(Main $IPAM)
		{
			self::$_IPAM = $IPAM;
		}
	}