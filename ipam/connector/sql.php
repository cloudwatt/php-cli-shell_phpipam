<?php
	class IPAM_Connector_Sql extends IPAM_Connector_Abstract
	{
		protected $_mysqli;
		...
		{
			Tools::e(PHP_EOL."Connection SQL à l'IPAM @ ".$server." veuillez patienter ... ", 'blue');
